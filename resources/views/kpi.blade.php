...
<div class="container-fluid position-relative d-flex p-0">
    ...
    <div class="content">
        ...
        <!-- Sale & Revenue Start -->
        <div class="destock">
            <div class="m-0" id="reportContainer" style="height: 100vh; min-height: 880px; max-height: 1500px;"></div>
        </div>

        <div class="mobil">
            <div class="m-0" id="reportContainerMobil" style="height: 1500px;"></div>
        </div>
        <!-- Sale & Revenue End -->
    </div>
    <!-- Content End -->
