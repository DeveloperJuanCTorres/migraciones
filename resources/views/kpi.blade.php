...
<div class="container-fluid position-relative d-flex p-0">
    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="/kpi" class="nav-item nav-link active"><i class="far fa-file-alt me-2 icolor"></i>KPI</a>
    ...
    <div class="content">
        ...
        src="https://app.powerbi.com/view?r=eyJrIjoiMGRjMWFlZTgtNmE0OC00OTgwLThmMWYtNTkyMDgxMjEwOTZiIiwidCI6IjVmMWIyMGVkLWVlM2QtNDQ3OC05ZDhhLTAwN2I2ZGM2NjRiOCIsImMiOjR9" frameborder="0" allowFullScreen="true"></iframe>
        </div>
